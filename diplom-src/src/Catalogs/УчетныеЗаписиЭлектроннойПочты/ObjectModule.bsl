...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ПустаяСтрока(АдресЭлектроннойПочты)
		И Не ОбщегоНазначенияКлиентСервер.АдресЭлектроннойПочтыСоответствуетТребованиям(АдресЭлектроннойПочты, Истина) Тогда
...
Процедура ПриЗаписи(Отказ)
	...
	Если УчетнаяЗаписьДляВосстановленияПароля.Используется И УчетнаяЗаписьДляВосстановленияПароля.УчетнаяЗаписьПочты
		= Ссылка Тогда
