...
Процедура ВключитьВозможностьРедактирования(Команда)
	...
	ПоказатьПредупреждение( , НСтр("ru = 'Ключ доступа не следует изменять, так как он сопоставлен с разными объектами.
...
Функция РасшифровкаСоставаПолей(СоставПолей)
	...
	Пока ТекущееЧисло > 0 Цикл
		...
		Иначе
			Расшифровка = Расшифровка + ", " + НСтр("ru = 'Табличная часть'") + " " + НомерТабличнойЧасти + ": "
				+ Остаток;
		КонецЕсли;
