	...
	Для Каждого Условие Из УсловияВидимости Цикл
		...
		Если Не ЗначениеЗаполнено(Условие.ВидСравнения) Тогда
			...
			Поле = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				"УсловияВидимости[%1].ПредставлениеВидаСравнения", Формат(ИндексСтроки, "ЧГ=0;"));
		...
		Если Не ЗначениеЗаполнено(Условие.Поле) Тогда
			...
			Поле = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку("УсловияВидимости[%1].ПредставлениеПоля",
				Формат(ИндексСтроки, "ЧГ=0;"));
...
Процедура ЗаполнитьСписокВыбораПоля()
	...
	Для Каждого КоллекцияРеквизитов Из КоллекцииРеквизитов Цикл
		Для Каждого Реквизит Из КоллекцияРеквизитов Цикл
			...
			Элементы.УсловияВидимостиПоле.СписокВыбора.Добавить(ОписаниеРеквизита.Поле,
				ОписаниеРеквизита.ПредставлениеПоля);
		КонецЦикла;
	КонецЦикла;
