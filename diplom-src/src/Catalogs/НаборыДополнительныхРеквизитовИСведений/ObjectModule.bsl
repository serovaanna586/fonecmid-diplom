...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоГруппа Тогда
		...
		Для Каждого ДополнительныйРеквизит Из ДополнительныеРеквизиты Цикл
			...
			Если ДополнительныйРеквизит.Свойство.Пустая() Или ВыбранныеСвойства.Получить(
				ДополнительныйРеквизит.Свойство) <> Неопределено Тогда
		...
		Для Каждого ДополнительноеСведение Из ДополнительныеСведения Цикл
			...
			Если ДополнительноеСведение.Свойство.Пустая() Или ВыбранныеСвойства.Получить(
				ДополнительноеСведение.Свойство) <> Неопределено Тогда
