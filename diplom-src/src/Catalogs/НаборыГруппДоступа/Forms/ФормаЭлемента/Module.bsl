...
Процедура ВключитьВозможностьРедактирования(Команда)
	...
	ПоказатьПредупреждение( , НСтр("ru = 'Набор групп доступа не следует изменять, так как он сопоставлен с разными ключами доступа.
...
Процедура УстановитьСтраницуРеквизитовПоТипу(Форма)
	...
	Если ТипЗнч(Форма.Объект.ТипЭлементовНабора) = Тип("СправочникСсылка.Пользователи") Или ТипЗнч(
		Форма.Объект.ТипЭлементовНабора) = Тип("СправочникСсылка.ВнешниеПользователи") Тогда
