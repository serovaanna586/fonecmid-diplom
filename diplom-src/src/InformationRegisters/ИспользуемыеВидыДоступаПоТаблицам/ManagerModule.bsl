...
Процедура ОбновитьДанныеРегистра(Таблицы = Неопределено, ТипыЗначенийДоступа = Неопределено,
	...
	УправлениеДоступомСлужебный.УстановитьУсловиеОтбораВЗапросе(Запрос, Таблицы, "Таблицы", "&УсловиеОтбораТаблиц1:ТаблицыГруппДоступа.Таблица
																							|&УсловиеОтбораТаблиц2:СтарыеДанные.Таблица");

	УправлениеДоступомСлужебный.УстановитьУсловиеОтбораВЗапросе(Запрос, ТипыЗначенийДоступа, "ТипыЗначенийДоступа", "&УсловиеОтбораТиповЗначений1:ЗначенияГруппДоступаПоУмолчанию.ТипЗначенийДоступа
																													|&УсловиеОтбораТиповЗначений2:СтарыеДанные.ТипЗначенийДоступа");

	Если ТипыЗначенийДоступа <> Неопределено И Таблицы = Неопределено Тогда
