...
Функция НовыйЗапросОбновленияДанныхРегистра(СсылкиОбъектовМетаданных)
	...
	Если СсылкиОбъектовМетаданных = Неопределено Тогда
		ТекстЗапроса = СтрЗаменить(
			ТекстЗапроса, "ДополнительныеОтчетыИОбработкиНазначение.ОбъектНазначения В(&СсылкиОбъектовМетаданных)
						  |	И ", "");
	Иначе
		Запрос.УстановитьПараметр("СсылкиОбъектовМетаданных", СсылкиОбъектовМетаданных);
	КонецЕсли;

	Запрос.УстановитьПараметр("ПубликацияНеРавно",
		Перечисления.ВариантыПубликацииДополнительныхОтчетовИОбработок.Отключена);
	Запрос.УстановитьПараметр("ВидЗаполнениеОбъекта",
		Перечисления.ВидыДополнительныхОтчетовИОбработок.ЗаполнениеОбъекта);
	...
	Запрос.УстановитьПараметр("ВидСозданиеСвязанныхОбъектов",
		Перечисления.ВидыДополнительныхОтчетовИОбработок.СозданиеСвязанныхОбъектов);
