...
Процедура ЗаполнитьБыстрыеНастройки()
	...
	Для Каждого СведенияОНастройке Из СведенияОНастройках Цикл
		...
		Запись.Пометка = (ЭлементНастроек.РежимОтображения
			= РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
		Запись.Заголовок = ЗаголовокНастройки(ЭлементНастроек, ОписаниеНастройки, ТипНастройки,
...
Функция ЗаголовокНастройки(ЭлементНастроек, ОписаниеНастройки, ТипНастройки, ЭлементПользовательскихНастроек)
	...
	ЗначениеНастройки = ЗначениеНастройки(ЭлементНастроек, ОписаниеНастройки, ТипНастройки,
		ЭлементПользовательскихНастроек);
...
Функция ЗначениеНастройки(ЭлементНастроек, ОписаниеНастройки, ТипНастройки, ЭлементПользовательскихНастроек)
	...
	Если ТипНастройки = Тип("ЗначениеПараметраНастроекКомпоновкиДанных") И ТипЗнч(
		ЭлементПользовательскихНастроек.Значение) <> Тип("Булево") Тогда

		ЗначениеНастройки = ЭлементПользовательскихНастроек.Значение;
		ИмяПоляНастройки = Строка(ЭлементНастроек.Параметр);

	ИначеЕсли ТипНастройки = Тип("ЭлементОтбораКомпоновкиДанных") И Не (ТипЗнч(
		ЭлементПользовательскихНастроек.ПравоеЗначение) = Тип("Булево") И ЗначениеЗаполнено(
		ЭлементНастроек.Представление)) Тогда
	...
	Если ИмяПоляНастройки = Неопределено Или ТипЗнч(ДоступныеЗначения) <> Тип("Структура") Тогда
...
Функция ПредставлениеНастройки(ЭлементНастроек, ОписаниеНастройки, ТипНастройки)
	...
	ИначеЕсли ТипНастройки = Тип("НастройкиКомпоновкиДанных") Или ТипНастройки = Тип("ГруппировкаКомпоновкиДанных")
		Или ТипНастройки = Тип("ДиаграммаКомпоновкиДанных") Или ТипНастройки = Тип(
		"ГруппировкаДиаграммыКомпоновкиДанных") Или ТипНастройки = Тип("ТаблицаКомпоновкиДанных") Или ТипНастройки
		= Тип("ГруппировкаТаблицыКомпоновкиДанных") Тогда

		ПредставлениеНастройки = ВариантыОтчетовСлужебный.ПредставлениеЭлементаСтруктуры(ЭлементНастроек);

	ИначеЕсли ТипНастройки = Тип("КоллекцияЭлементовСтруктурыНастроекКомпоновкиДанных") Или ТипНастройки = Тип(
		"КоллекцияЭлементовСтруктурыТаблицыКомпоновкиДанных") Или ТипНастройки = Тип(
...
Функция КартинкаНастройки(ЭлементНастроек, ТипНастройки)
	...
	Если ТипНастройки = Тип("ЗначениеПараметраНастроекКомпоновкиДанных") Или ТипНастройки = Тип(
	...
	ИначеЕсли ТипНастройки = Тип("ГруппировкаКомпоновкиДанных") Или ТипНастройки = Тип(
		"ГруппировкаДиаграммыКомпоновкиДанных") Или ТипНастройки = Тип("ГруппировкаТаблицыКомпоновкиДанных") Тогда
	...
	ИначеЕсли ТипНастройки = Тип("УсловноеОформлениеКомпоновкиДанных") Или ТипНастройки = Тип(
...
Процедура УстановитьУсловиеФильтра(Запись, ОписаниеНастройки, ТипНастройки, ИдентификаторПользовательскойНастройки)
	...
	Если ТипНастройки <> Тип("ЗначениеПараметраНастроекКомпоновкиДанных") И ТипНастройки <> Тип(
		"ЭлементОтбораКомпоновкиДанных") Тогда
...
Процедура ВыбратьВидСравнения(Элемент, СтандартнаяОбработка)
	...
	ПоказатьВыборИзМеню(
		Новый ОписаниеОповещения("ПослеВыбораВидаСравнения", ЭтотОбъект, ПараметрыВыбора), Запись.ДоступныеВидыСравнения,
		Элемент);
