...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИдентификаторПроверки = "РаботаСАдресами.ИсправитьТипЗданияЛитерВАдресах" Тогда
		...
		Элементы.Пояснение.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			Элементы.Пояснение.Заголовок, Строка(Параметры.ВидПроверки.Свойство2));
	Иначе
...
Функция ИсправитьУстаревшиеАдресаВФоне(ИдентификаторПроверки)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр(
		"ru = 'Исправление устаревших адресов контактной информации'");
...
Функция ИсправитьАдресаСТипомЛитерВФоне(ИдентификаторПроверки)
	...
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр(
		"ru = 'Исправление адресов контактной информации  с типом здания Литер'");
