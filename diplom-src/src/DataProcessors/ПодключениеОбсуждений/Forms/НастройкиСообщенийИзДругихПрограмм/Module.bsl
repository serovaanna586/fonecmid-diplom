...
Процедура СоздатьБотаТелеграмм(Команда)
	...
	ОбсужденияСлужебныйКлиент.ПоказатьИнформациюОбИнтеграции(ЭтотОбъект, Новый Структура("Тип",
		ОбсужденияСлужебныйКлиентСервер.ТипыВнешнихСистем().Телеграм), Оповещение);
КонецПроцедуры
...
Процедура СоздатьБотаВКонтакте(Команда)
	Оповещение = Новый ОписаниеОповещения("ПослеИзмененияИнтеграции", ЭтотОбъект);
	ОбсужденияСлужебныйКлиент.ПоказатьИнформациюОбИнтеграции(ЭтотОбъект, Новый Структура("Тип",
		ОбсужденияСлужебныйКлиентСервер.ТипыВнешнихСистем().ВКонтакте), Оповещение);
КонецПроцедуры
...
Процедура СписокПодключенийВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ОбсужденияСлужебныйКлиент.ПоказатьИнформациюОбИнтеграции(
		ЭтотОбъект, ПараметрыФормы, Оповещение);
КонецПроцедуры
