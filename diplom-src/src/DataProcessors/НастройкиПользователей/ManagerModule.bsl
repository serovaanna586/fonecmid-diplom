...
Функция НастройкиВсехФорм(ИмяПользователя)
	...
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventsJournal", НСтр(
		"ru = 'Стандартные.Журнал регистрации'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventForm", НСтр(
		"ru = 'Стандартные.Журнал регистрации, Событие'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventsJournalFilter", НСтр(
		"ru = 'Стандартные.Журнал регистрации, Настройка отбора событий'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardFindByRef.Форма.MainForm", НСтр(
		"ru = 'Стандартные.Поиск ссылок на объект'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardFullTextSearchManagement.Форма.MainForm", НСтр(
		"ru = 'Стандартные.Управление полнотекстовым поиском'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardDocumentsPosting.Форма.MainForm", НСтр(
		"ru = 'Стандартные.Проведение документов'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardDeleteMarkedObjects.Форма.Form", НСтр(
		"ru = 'Стандартные.Удаление помеченных объектов'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardExternalDataSourceManagement.Форма.Form", НСтр(
		"ru = 'Стандартные.Управление внешними источниками данных'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardTotalsManagement.Форма.MainForm", НСтр(
		"ru = 'Стандартные.Управление итогами'"), Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardActiveUsers.Форма.ActiveUsersListForm", НСтр(
		"ru = 'Стандартные.Активные пользователи'"), Ложь, БиблиотекаКартинок.Форма);
...
Функция ФормыОбъектовМетаданных()
	...
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ХранилищаНастроек, "ХранилищеНастроек", НСтр(
		"ru = 'Хранилище настроек'"), ИменаСтандартныхФорм, БиблиотекаКартинок.ХранилищеНастроек, СписокФорм);
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Документы, "Документ", НСтр("ru = 'Документ'"), ИменаСтандартныхФорм,
		БиблиотекаКартинок.Документ, СписокФорм);
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Отчеты, "Отчет", НСтр("ru = 'Отчет'"), ИменаСтандартныхФорм,
		БиблиотекаКартинок.Отчет, СписокФорм);

	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Обработки, "Обработка", НСтр("ru = 'Обработка'"), ИменаСтандартныхФорм,
		БиблиотекаКартинок.Обработка, СписокФорм);
	...
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбораГруппы", "ФормаВыбораГруппы");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовХарактеристик, "ПланВидовХарактеристик", НСтр(
		"ru = 'План видов характеристик'"), ИменаСтандартныхФорм, БиблиотекаКартинок.ПланВидовХарактеристик, СписокФорм);
	...
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыНакопления, "РегистрНакопления", НСтр(
		"ru = 'Регистр накопления'"), ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрНакопления, СписокФорм);

	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыБухгалтерии, "РегистрБухгалтерии", НСтр(
		"ru = 'Регистр бухгалтерии'"), ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрБухгалтерии, СписокФорм);
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Задачи, "Задача", НСтр("ru = 'Задача'"), ИменаСтандартныхФорм,
		БиблиотекаКартинок.Задача, СписокФорм);

	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ВнешниеИсточникиДанных, "ВнешнийИсточникДанных", НСтр(
		"ru = 'Внешние источники данных'"), ИменаСтандартныхФорм, БиблиотекаКартинок.ВнешнийИсточникДанныхТаблица,
		СписокФорм);
...
Процедура ЗаполнитьФормыОбъектовМетаданных(СписокОбъектовМетаданных, ТипОбъектаМетаданных,
	...
	Для Каждого Объект Из СписокОбъектовМетаданных Цикл
		...
		Если ТипОбъектаМетаданных = "ВнешнийИсточникДанных" Тогда
			ЗаполнитьФормыВнешнихИсточниковДанных(Объект, ТипОбъектаМетаданных, ПредставлениеОбъектаМетаданных,
				Картинка, СписокФорм);
			Продолжить;
		КонецЕсли;
		...
		Для Каждого Форма Из Объект.Формы Цикл
			...
			СписокФорм.Добавить(ПрефиксИмени + ".Форма." + Форма.Имя, ПрефиксПредставления + ПредставлениеФормы,
				Пометка, Картинка);
		КонецЦикла;
		...
		Для Каждого ИмяСтандартнойФормы Из ИменаСтандартныхФорм Цикл
			...
			Если Форма = Неопределено Тогда
				ИмяФормы = ?(ЗначениеЗаполнено(ИмяСтандартнойФормы.Представление), ИмяСтандартнойФормы.Представление,
					ИмяСтандартнойФормы.Значение);
				ПредставлениеФормыИПометка = ПредставлениеАвтогенерируемойФормы(Объект, ИмяСтандартнойФормы.Значение,
					ТипОбъектаМетаданных);
				ПредставлениеФормы = ПредставлениеФормыИПометка.ИмяФормы;
				Пометка = ПредставлениеФормыИПометка.ФормаОткрываемая;
				СписокФорм.Добавить(ПрефиксИмени + "." + ИмяФормы, ПрефиксПредставления + ПредставлениеФормы, Пометка,
					Картинка);
			КонецЕсли;
...
Процедура ЗаполнитьФормыВнешнихИсточниковДанных(Объект, ТипОбъектаМетаданных, ПредставлениеОбъектаМетаданных, Картинка,
	СписокФорм)
	...
	Для Каждого Таблица Из Объект.Таблицы Цикл
		...
		Для Каждого Форма Из Таблица.Формы Цикл
			...
			СписокФорм.Добавить(ПрефиксИмени + Таблица.Имя + ".Форма." + Форма.Имя, ПрефиксПредставления
				+ ПредставлениеФормы, Ложь, Картинка);
		КонецЦикла;
	...
	Для Каждого ОчищаемаяНастройка Из ОчищаемыеНастройки Цикл
		...
		Для Каждого Источник Из Источники Цикл
			...
			Если ОчищаемаяНастройка = "ПрочиеПользовательскиеНастройки" Тогда
				...
				ПользователиСлужебный.ПриПолученииПрочихНастроекПользователя(СведенияОПользователе,
					ПрочиеНастройкиПользователей);
				...
				Если ПрочиеНастройкиПользователей.Количество() <> 0 Тогда
					...
					Для Каждого ПрочаяНастройка Из ПрочиеНастройкиПользователей Цикл
						...
						Иначе
							...
							ПрочиеНастройкиСтруктура.Вставить("ЗначениеНастройки",
								ПрочаяНастройка.Значение.СписокНастроек);
						КонецЕсли;

						ПользователиСлужебный.ПриУдаленииПрочихНастроекПользователя(СведенияОПользователе,
			...
			Если ОчищаемаяНастройка = "НастройкиОтчетов" Тогда
				...
				Если ТаблицаПользовательскихВариантовОтчетов = Неопределено Или Источники.Количество() <> 1 Тогда
				...
				Для Каждого ВариантОтчета Из ТаблицаПользовательскихВариантовОтчетов Цикл
					...
					ИнтеграцияПодсистемБСП.ПриУдаленииПользовательскихВариантовОтчета(ВариантОтчета, ПользовательИБ,
						СтандартнаяОбработка);

					Если СтандартнаяОбработка Тогда
						ХранилищеВариантовОтчетов.Удалить(ВариантОтчета.КлючОбъекта, ВариантОтчета.КлючВарианта,
							ПользовательИБ);
					КонецЕсли;
			...
			Если ОчищаемаяНастройка = "НастройкиВнешнегоВида" Тогда
				НастройкиИзХранилища = ЧтениеНастроекИзХранилища(ХранилищеПользовательскихНастроекДинамическихСписков,
					ПользовательИБ);
				УдалитьНастройки(ХранилищеПользовательскихНастроекДинамическихСписков, НастройкиИзХранилища,
					ПользовательИБ);
			КонецЕсли;
			...
			ПользователиСлужебный.УстановитьНачальныеНастройки(ПользовательИБ, ТипЗнч(Источник) = Тип(
...
Функция ИменаТиповОбъектов()
	...
	ЯзыкРусский = Метаданные.ВариантВстроенногоЯзыка = Метаданные.СвойстваОбъектов.ВариантВстроенногоЯзыка.Русский;
...
Процедура УдалитьУстаревшуюНастройку(Выборка, Хранилище, Контекст)
	...
	Если ЧастиИмени.Количество() > 3 И (ВРег(ЧастиИмени[2]) = ВРег("Форма") // @Non-NLS

		Или ВРег(ЧастиИмени[2]) = ВРег("Form")) Тогда

		ПолноеИмяОбъекта = ЧастиИмени[0] + "." + ЧастиИмени[1] + "." + ЧастиИмени[2] + "." + ЧастиИмени[3];
	...
	Для Каждого КопируемаяНастройка Из КопируемыеНастройки Цикл
		...
		Если КопируемаяНастройка = "ПрочиеПользовательскиеНастройки" Тогда
			Для Каждого ПользовательПриемник Из ПользователиПриемник Цикл
				...
				СведенияОПользователе.Вставить("ИмяПользователяИнформационнойБазы", ИмяПользователяИБ(
		...
		Если КопируемаяНастройка = "НастройкиОтчетов" Тогда
			...
			Если ТипЗнч(СоответствиеНастройкаХранилище["ВариантыОтчетов"]) = Тип(
				"СтандартноеХранилищеНастроекМенеджер") Тогда
		...
		Если КопируемаяНастройка = "НастройкиВнешнегоВида" Тогда
			НастройкиДинамическихСписков = ЧтениеНастроекИзХранилища(
				ХранилищеПользовательскихНастроекДинамическихСписков, ПользовательИсточник);
			СкопироватьНастройкиДинамическихСписков(ПолучателиНастроек, ПользовательИсточник,
		...
		Для Каждого ПользовательПриемник Из ПользователиПриемник Цикл
			СкопироватьНастройки(
				МенеджерНастроек, НастройкиИзХранилища, ПользовательИсточник, ПользовательПриемник,
...
Функция СписокНастроек(ИмяПользователя, МенеджерНастроек, КопируемаяНастройка,
	ТаблицаКлючейИТиповВариантовОтчетов = Неопределено, ДляКопирования = Ложь)
	...
	Пока СледующаяНастройка(ВыборкаНастроек) Цикл
		...
		Если Не ПолучитьИзбранное И СтрНайти(ВыборкаНастроек.КлючОбъекта, "ИзбранноеРаботыПользователя") <> 0 Тогда
			Продолжить;
		...
		Если Не ПолучитьНастройкиПечати И СтрНайти(ВыборкаНастроек.КлючОбъекта, "НастройкиПечатиТабличногоДокумента")
			<> 0 Тогда
			Продолжить;
		...
		Если ТаблицаКлючейИТиповВариантовОтчетов <> Неопределено Тогда
			...
			НайденныйВариантОтчета = ТаблицаКлючейИТиповВариантовОтчетов.Найти(ВыборкаНастроек.КлючОбъекта,
				"КлючВарианта");
...
Процедура СкопироватьНастройки(МенеджерНастроек, ТаблицаНастроек, ПользовательИсточник, ПользовательПриемник,
	...
	Для Каждого Настройка Из ТаблицаНастроек Цикл
		...
		Если МенеджерНастроек = ХранилищеПользовательскихНастроекОтчетов Или МенеджерНастроек
			= ХранилищеВариантовОтчетов Тогда
			...
			Если МассивДоступныхОтчетов.Найти(КлючОтчета[0]) = Неопределено Тогда
				...
				Если МенеджерНастроек = ХранилищеПользовательскихНастроекОтчетов И НеСкопированныеНастройкиОтчетов
					<> Неопределено Тогда
		...
		МенеджерНастроек.Сохранить(КлючОбъекта, КлючНастройки, Значение, ОписаниеНастроек, ПользовательПриемникИБ);
	КонецЦикла;

	Если Не ОбщегоНазначения.ИнформационнаяБазаФайловая() И ОчередьНастроек.Количество() > 0 Тогда
		...
		Для Каждого Элемент Из МассивНастроекДляКопирования Цикл
			...
			Для Каждого ЭлементНастроек Из Элемент Цикл
				...
				Если Настройка <> Неопределено Тогда
					...
					МенеджерНастроек.Сохранить(КлючОбъекта, КлючНастроек, Настройка, ОписаниеНастройки,
...
Процедура СкопироватьНастройкиВнешнегоВида(ПользовательИсточник, ПользователиПриемник, МассивНастроекДляКопирования) Экспорт
	...
	НастройкиДинамическихСписков = ЧтениеНастроекИзХранилища(ХранилищеПользовательскихНастроекДинамическихСписков,
	...
	Для Каждого Элемент Из МассивНастроекДляКопирования Цикл
		...
		Для Каждого ЭлементНастроек Из Элемент Цикл
			...
			Если КлючНастроек = "Интерфейс" Или КлючНастроек = "Прочие" Тогда
...
Процедура СкопироватьНастройкиДинамическихСписков(ПолучателиНастроек, ПользовательИсточник, Настройки)
	...
	Для Каждого Настройка Из Настройки Цикл
		Значение = ХранилищеПользовательскихНастроекДинамическихСписков.Загрузить(
			Настройка.КлючОбъекта, Настройка.КлючНастроек, , ПользовательИсточник);
		Если Значение <> Неопределено Тогда
			Для Каждого ПользовательПриемникИБ Из ПолучателиНастроек Цикл
				...
				ХранилищеПользовательскихНастроекДинамическихСписков.Сохранить(
					Настройка.КлючОбъекта, Настройка.КлючНастроек, Значение, ОписаниеНастроек, ПользовательПриемникИБ);
			КонецЦикла;
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗаполнитьОчередьНастроек(ОчередьНастроек, ПолучательНастроек)
	...
	СтарыеНастройки = ХранилищеОбщихНастроек.Загрузить("ОчередьНастроек", "НеПримененныеНастройки", ,
		ПолучательНастроек);
	...
	ХранилищеОбщихНастроек.Сохранить(
		"ОчередьНастроек", "НеПримененныеНастройки", Новый ХранилищеЗначения(ОчередьНастроек, Новый СжатиеДанных(9)), ,
		ПолучательНастроек);
...
Процедура УдалитьВыбранныеНастройки(СведенияОПользователе, МассивНастроекДляУдаления, ИмяХранилища) Экспорт
	...
	ИначеЕсли ИмяХранилища = "ХранилищеСистемныхНастроек" Тогда
		...
		Для Каждого Элемент Из МассивНастроекДляУдаления Цикл
			...
			Для Каждого Настройка Из Элемент Цикл
				...
				Если Настройка.Представление = "Интерфейс" Или Настройка.Представление = "Прочие" Тогда
					...
					Если Настройка.Значение = "Общее/НастройкиКлиентскогоПриложения" Или Настройка.Значение = "Общее/ПанельРазделов/НастройкиКомандногоИнтерфейса"
				...
				Иначе
					...
					Если ОбработанныеКлючи[ИмяОбъекта] = Неопределено Тогда
						...
						Пока ВыборкаНастроек.Следующий() Цикл
							ХранилищеПользовательскихНастроекДинамическихСписков.Удалить(ВыборкаНастроек.КлючОбъекта,
								ВыборкаНастроек.КлючНастроек, ПользовательИБ);
						КонецЦикла;
						ОбработанныеКлючи.Вставить(ИмяОбъекта, Истина);
					КонецЕсли;
		...
		Если УстановитьНачальныеНастройки Тогда
			ПользователиСлужебный.УстановитьНачальныеНастройки(ПользовательИБ, ТипЗнч(ПользовательСсылка) = Тип(
				"СправочникСсылка.ВнешниеПользователи"));
		КонецЕсли;
...
Процедура УдалитьВариантыОтчетов(МассивВариантовОтчетов, ТаблицаПользовательскихВариантовОтчетов,
	ПользовательИнформационнойБазы) Экспорт
...
Процедура СкопироватьВариантыОтчетов(МассивВариантовОтчетов, ТаблицаПользовательскихВариантовОтчетов,
	...
	Для Каждого Настройка Из МассивВариантовОтчетов Цикл
		...
		Если НайденныйВариантОтчета[0].СтандартнаяОбработка Тогда
			...
			Попытка
				Значение = ХранилищеВариантовОтчетов.Загрузить(КлючОтчета, КлючВарианта, ,
					ПользовательИнформационнойБазы);
			Исключение
				Продолжить;
			КонецПопытки;
			ОписаниеНастройки = ХранилищеВариантовОтчетов.ПолучитьОписание(КлючОтчета, КлючВарианта,
				ПользовательИнформационнойБазы);

			Для Каждого ПолучательНастроек Из ПользователиПолучатели Цикл
				ПолучательНастроек = ИмяПользователяИБ(ПолучательНастроек);
				ХранилищеВариантовОтчетов.Сохранить(КлючОтчета, КлючВарианта, Значение, ОписаниеНастройки,
					ПолучательНастроек);
			КонецЦикла;
...
Функция ТекстЗапросаСпискаПользователей(Очистка)
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&КромеПомеченныхНаУдаление", ?(Очистка, "Истина",
		"НЕ Пользователи.ПометкаУдаления"));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&КромеНедействительных", ?(Очистка, "Истина",
		"НЕ Пользователи.Недействителен"));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&КромеСлужебныхПользователей", ?(Очистка
		И Не ОбщегоНазначения.РазделениеВключено(), "Истина", "НЕ Пользователи.Служебный"));
...
Функция ГруппыПользователей(ПользовательВнешний)
	...
	Возврат Новый Структура("ГруппыПользователейСписок, ТаблицаГруппыИСостав", ГруппыПользователейСписок,
		ТаблицаГруппыИСостав);
КонецФункции
...
Функция ПолныйСоставГруппПользователей(ГруппыПользователейСостав)
	...
	Для Каждого СтрокаСостава Из ГруппыПользователейСостав Цикл
		...
		Если ТипЗнч(СтрокаСостава.ГруппаПользователей) = Тип("СправочникСсылка.ГруппыПользователей") Или ТипЗнч(
			СтрокаСостава.ГруппаПользователей) = Тип("СправочникСсылка.ГруппыВнешнихПользователей") Тогда
...
Функция ПредставлениеФормы(Объект, Форма, ТипОбъектаМетаданных)
	...
	Если ТипОбъектаМетаданных = "КритерийОтбора" Или ТипОбъектаМетаданных = "ЖурналДокументов" Тогда
	...
	ИначеЕсли ТипОбъектаМетаданных = "РегистрНакопления" Или ТипОбъектаМетаданных = "РегистрБухгалтерии"
	...
	ИначеЕсли ТипОбъектаМетаданных = "Отчет" Или ТипОбъектаМетаданных = "Обработка" Тогда
	...
	ИначеЕсли ТипОбъектаМетаданных = "Перечисление" Тогда
		...
		Если Форма = Объект.ОсновнаяФормаСписка Или Форма = Объект.ОсновнаяФормаДляВыбора Тогда
			ИмяФормы = ОбщегоНазначения.ПредставлениеСписка(Объект);
	...
	ИначеЕсли ТипОбъектаМетаданных = "Справочник" Или ТипОбъектаМетаданных = "ПланВидовХарактеристик" Тогда

		Если Форма = Объект.ОсновнаяФормаСписка Или Форма = Объект.ОсновнаяФормаДляВыбора Или Форма = Объект.ОсновнаяФормаГруппы
...
Функция ПредставлениеАвтогенерируемойФормы(Объект, Форма, ТипОбъектаМетаданных)
	...
	ИначеЕсли ТипОбъектаМетаданных = "Справочник" Или ТипОбъектаМетаданных = "ПланВидовХарактеристик" Тогда
		...
		Если Форма = "ФормаСписка" Или Форма = "ФормаДляВыбора" Или Форма = "ФормаГруппы" Или Форма
			= "ФормаДляВыбораГруппы" Тогда
			ИмяФормы = ОбщегоНазначения.ПредставлениеСписка(Объект);
	...
	Иначе // Получение представления формы для Документа, Плана счетов, Плана видов расчета, Бизнес-процесса и Задачи.
		...
		Если Форма = "ФормаСписка" Или Форма = "ФормаДляВыбора" Тогда
			ИмяФормы = ОбщегоНазначения.ПредставлениеСписка(Объект);
			ФормаОткрываемая = ?(Форма = "ФормаСписка", Истина, Ложь);
		ИначеЕсли Форма = "ФормаОбъекта" Тогда
			ИмяФормы = ОбщегоНазначения.ПредставлениеОбъекта(Объект);
...
Функция ФормированиеОтчетаОКопировании(НеСкопированныеНастройкиОтчетов,
	...
	ОтчетНеПустой = Ложь;
	Если ТаблицаПользовательскихВариантовОтчетов <> Неопределено И ТаблицаПользовательскихВариантовОтчетов.Количество()
		<> 0 Тогда
		ОбластьЗаголовок = ТабМакет.ПолучитьОбласть("Заголовок");
		ОбластьЗаголовок.Параметры.Описание = НСтр("ru = 'Невозможно скопировать личные варианты отчетов.
	...
	Если НеСкопированныеНастройкиОтчетов.Количество() <> 0 Тогда
		ОбластьЗаголовок = ТабМакет.ПолучитьОбласть("Заголовок");
		ОбластьЗаголовок.Параметры.Описание = НСтр("ru = 'У следующих пользователей недостаточно прав на отчеты:'");
		ТабДок.Вывести(ОбластьЗаголовок);
...
Функция ПропуститьНастройку(КлючОбъекта, КлючНастроек)
	...
	Если ИсключенияПоКлючуОбъекта.Найти(КлючОбъекта) <> Неопределено И ИсключенияПоКлючуНастроек.Найти(КлючНастроек)
		<> Неопределено Тогда
		Возврат Истина;
	КонецЕсли;
...
Процедура ЗаполнитьСписокНастроекОтчетов(Параметры)
	...
	Для Каждого Настройка Из Настройки Цикл
		...
		Если ПредставлениеВариантаОтчета = "" Или ПредставлениеВариантаОтчета = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		...
		Если ИмяФормы[3] = "ВыборНастроек" И НайденныйВариантОтчета <> Неопределено
			И Не НайденныйВариантОтчета.СтандартнаяОбработка Тогда
			Продолжить;
		КонецЕсли;

		Если Не ПустаяСтрока(Параметры.Поиск) Тогда
			Если СтрНайти(ВРег(ПредставлениеВариантаОтчета), ВРег(Параметры.Поиск)) = 0 И СтрНайти(ВРег(
				НазваниеНастройки), ВРег(Параметры.Поиск)) = 0 Тогда
				Продолжить;
			КонецЕсли;
		КонецЕсли;
		...
		Если ТекущийОбъект <> ПредставлениеВариантаОтчета Тогда
			...
			НоваяСтрокаВариантОтчета.Тип = ?(НайденныйВариантОтчета <> Неопределено, ?(
				Не НайденныйВариантОтчета.СтандартнаяОбработка, "ВариантЛичный", "СтандартныйВариантЛичный"),
				"СтандартныйВариантОтчета");
		...
		НоваяСтрокаНастройка.Настройка = ?(Не ПустаяСтрока(НазваниеНастройки), НазваниеНастройки,
			ПредставлениеВариантаОтчета);
		НоваяСтрокаНастройка.Картинка = КартинкаФорма;
		НоваяСтрокаНастройка.Тип = ?(НайденныйВариантОтчета <> Неопределено, ?(
			Не НайденныйВариантОтчета.СтандартнаяОбработка, "НастройкаЛичная", "СтандартнаяНастройкаЛичная"),
			"НастройкаСтандартногоОтчета");
	...
	Для Каждого ВариантОтчета Из ТаблицаВариантовОтчетов Цикл
		...
		Если ИмяФормы[3] = "ВыборНастроек" И Параметры.ДействиеСНастройками = "Копирование"
		...
		НоваяСтрокаВариантОтчета.Тип = ?(Не ВариантОтчета.СтандартнаяОбработка, "ВариантЛичный",
			"СтандартныйВариантЛичный");
...
Процедура ЗаполнитьСписокПрочихНастроек(Параметры)
	...
	Если ЕстьНастройкиПечати И ВыводитьНастройку Тогда
	...
	Если ЕстьИзбранное И ВыводитьНастройку Тогда
	...
	Если ПрочиеКлючи.Количество() <> 0 И ВыводитьНастройку Тогда
...
Процедура ДобавитьНастройкиРабочегоСтолаИКомандногоИнтерфейса(Параметры, ДеревоНастроек)
	...
	Для Каждого Настройка Из Настройки Цикл
		...
		ИначеЕсли ИмяНастройки[0] = "Общее" Тогда
			...
			Если ИмяНастройки[1] = "ПанельРазделов" Или ИмяНастройки[1] = "ПанельДействий" Или ИмяНастройки[1] = "НастройкиКлиентскогоПриложения"
				Или ИмяНастройки[1] = "НастройкиИнтерфейсаКлиентскогоПриложения" Тогда

				КлючиНастроекИнтерфейса.Добавить(Настройка.КлючОбъекта, "Интерфейс");
				КлючиВсехНастроек.Добавить(Настройка.КлючОбъекта, "Интерфейс");

			ИначеЕсли ИмяНастройки[1] = "НастройкиРабочегоСтола" Или ИмяНастройки[1] = "НастройкиНачальнойСтраницы" Тогда
