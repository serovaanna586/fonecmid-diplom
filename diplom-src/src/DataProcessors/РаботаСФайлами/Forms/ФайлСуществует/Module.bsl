...
Процедура ПерезаписатьВыполнить()
	...
	СтруктураВозврата = Новый Структура("ПрименитьДляВсех, КодВозврата", ПрименитьДляВсех, КодВозвратаДиалога.Да);
...
Процедура ПропуститьВыполнить()
	...
	СтруктураВозврата = Новый Структура("ПрименитьДляВсех, КодВозврата", ПрименитьДляВсех,
...
Процедура ПрерватьВыполнить()
	...
	СтруктураВозврата = Новый Структура("ПрименитьДляВсех, КодВозврата", ПрименитьДляВсех, КодВозвратаДиалога.Прервать);
	Закрыть(СтруктураВозврата);
...
Процедура УстановитьКнопкуУмолчания(ДействиеПоУмолчанию)
	...
	Если ДействиеПоУмолчанию = "" Или ДействиеПоУмолчанию = "Пропустить" Тогда
