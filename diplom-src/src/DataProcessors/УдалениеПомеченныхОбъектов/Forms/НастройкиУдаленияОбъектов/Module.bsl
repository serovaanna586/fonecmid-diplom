...
Процедура ИспользоватьРегламентноеУдалениеПриИзменении(Элемент)
	...
	УдалениеПомеченныхОбъектовКлиент.ПриИзмененииФлажкаУдалятьПоРасписанию(АвтоматическиУдалятьПомеченныеОбъекты,
...
Процедура ДобавитьПолеНастройки(Команда)
	...
	ОповещениеОВыборе = Новый ОписаниеОповещения("ДобавитьПолеНастройкиЗавершение", ЭтотОбъект,
...
Функция ПодготовитьНастройки(УникальныйИдентификатор)
	Возврат ПоместитьВоВременноеХранилище(НастройкиИзДанныхФормы(), УникальныйИдентификатор);
КонецФункции
...
Функция НачатьПроверкаБлокировкиУдаляемыхОбъектовСервер()
	...
	Возврат ДлительныеОперации.ВыполнитьПроцедуру(
		ПараметрыФоновогоЗадания, "УдалениеПомеченныхОбъектовСлужебный.КонтрольУдаленияПомеченныхОбъектов");
