...
Процедура ПеренестиНастройки() Экспорт
	...
	Попытка
		...
		ЗаписьЖурналаРегистрации(
			...
			Метаданные.Константы.НастройкиВходаПользователей, , НСтр(
			"ru = 'Настройки входа пользователей успешно перенесены'"));
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			...
			Метаданные.Константы.НастройкиВходаПользователей, , ТекстОшибки);
