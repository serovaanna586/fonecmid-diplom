...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МассивПредставлений = ?(Параметры.ЭтоОтбор, СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(
		Параметры.Назначение, ", "), Неопределено);

	Если Параметры.ВыбиратьПользователей Тогда
		ДобавитьСтрокуТипа(Справочники.Пользователи.ПустаяСсылка(), Тип("СправочникСсылка.Пользователи"),
			МассивПредставлений);
	КонецЕсли;
