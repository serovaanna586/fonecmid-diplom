...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.СтрокаСсылочногоТипа И УправлениеСвойствамиСлужебный.ТипЗначенияСодержитЗначенияСвойств(
		Параметры.ТипЗначения) Тогда
...
Процедура КнопкаОк(Команда)
	Если СтрокаСсылочногоТипа Тогда
		...
		Иначе
			...
			ВозвращаемоеЗначение.Вставить("ФорматированнаяСтрока", СтроковыеФункцииКлиент.ФорматированнаяСтрока(
				Значение));
		КонецЕсли;
	Иначе
		Значение = Ссылка;
...
Функция ПустаяФорматированнаяСтрока()
	...
	Результат            = Новый ФорматированнаяСтрока(ПредставлениеЗначения, , ЦветаСтиля.ЦветПустойГиперссылки, ,
