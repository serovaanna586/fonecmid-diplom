...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//ЛЕА.05.11.2023 Добавляю профили групп доступа КадровикРасчетчик, Специалист, Менеджер, БухгалтерИТФирмы  используется начиная с версии 1.0.0.2
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Кадровик расчетчик";
	ОписаниеПрофиля.Идентификатор = "0ab577d8-fbac-4dcd-a1be-e5fe363efa73";
	...
	ОписаниеПрофиля.Идентификатор = "0ab577d8-fbac-4dcd-a1be-e5fe363efa74";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "0ab577d8-fbac-4dcd-a1be-e5fe363efa75";
	...
	ОписаниеПрофиля.Идентификатор = "0ab577d8-fbac-4dcd-a1be-e5fe363efa76";
