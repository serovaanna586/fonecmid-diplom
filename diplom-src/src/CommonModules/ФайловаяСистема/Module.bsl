	...
	Если Не ЭтоИмяВременногоФайла(Путь) Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Неверное значение параметра %1 в %2:
				 |Каталог не является временным ""%3"".'"), "Путь", "ФайловаяСистема.УдалитьВременныйКаталог", Путь);
	КонецЕсли;
...
Процедура УдалитьВременныйФайл(Знач Путь) Экспорт
	...
	Если Не ЭтоИмяВременногоФайла(Путь) Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Неверное значение параметра %1 в %2:
				 |Файл не является временным ""%3"".'"), "Путь", "ФайловаяСистема.УдалитьВременныйФайл", Путь);
	КонецЕсли;
		...
		Если Не ФайлИнфо.Существует() Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось запустить программу
					 ...
					 |%3'"), СтрокаКоманды, "ТекущийКаталог", ТекущийКаталог);
		КонецЕсли;
