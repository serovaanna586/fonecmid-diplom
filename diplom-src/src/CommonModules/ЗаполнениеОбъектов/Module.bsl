...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	ЗаполнениеОбъектовПереопределяемый.ПередДобавлениемКомандЗаполнения(КомандыЗаполнения, НастройкиФормы,
	...
	Если СтандартнаяОбработка Тогда
		...
		Для Каждого Источник Из Источники.Строки Цикл
			Для Каждого ДокументРегистратор Из Источник.Строки Цикл
				Если Не ДокументРегистратор.ЭтоЖурналДокументов И Не ПравоДоступа("Изменение",
					ДокументРегистратор.Метаданные) Тогда
					Продолжить;
				КонецЕсли;
				...
				КонецЕсли;
			КонецЦикла;
			Если Не Источник.ЭтоЖурналДокументов И Не ПравоДоступа("Изменение", Источник.Метаданные) Тогда
				Продолжить;
			КонецЕсли;
