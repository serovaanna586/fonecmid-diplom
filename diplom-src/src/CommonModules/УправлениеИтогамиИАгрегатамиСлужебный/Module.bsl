...
Процедура УстановкаПериодаРассчитанныхИтоговОбработчикЗадания() Экспорт
	...
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(
		Метаданные.РегламентныеЗадания.УстановкаПериодаРассчитанныхИтогов);
...
Процедура ОбновитьРегламентноеЗадание(МетаданныеРегламентногоЗадания, Использование)
	...
	Для Каждого Задание Из Найденные Цикл
		...
		Если Не РасписаниеЗаполнено(Задание.Расписание) И Не ОбщегоНазначения.РазделениеВключено() Тогда
...
Функция РасписаниеЗаполнено(Расписание)
	Возврат Расписание <> Неопределено И Строка(Расписание) <> Строка(Новый РасписаниеРегламентногоЗадания);
КонецФункции
