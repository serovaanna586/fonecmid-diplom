...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОтдельныеЗначенияРеквизитаКомментарий.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		Элементы.ОтдельныеЗначенияРеквизитаКомментарий.Заголовок, ТекущийНаборСвойств);

	Элементы.ОбщиеЗначенияРеквизитовКомментарий.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		Элементы.ОбщиеЗначенияРеквизитовКомментарий.Заголовок, ТекущийНаборСвойств);

	Элементы.ОтдельныеЗначенияСведенияКомментарий.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		Элементы.ОтдельныеЗначенияСведенияКомментарий.Заголовок, ТекущийНаборСвойств);

	Элементы.ОбщиеЗначенияСведенийКомментарий.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура ЗаписатьЗавершение(ОткрытьСвойство)
	...
	Оповестить("Запись_ДополнительныеРеквизитыИСведения", Новый Структура("Ссылка", Свойство), Свойство);

	Оповестить("Запись_НаборыДополнительныхРеквизитовИСведений", Новый Структура("Ссылка", ТекущийНаборСвойств),
		ТекущийНаборСвойств);
...
Функция ЗаписатьНаСервере()
	...
	Результат = ДлительныеОперации.ВыполнитьВФоне(
		"ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.ИзменитьНастройкуСвойства", ПараметрыПроцедуры,
		ПараметрыВыполнения);
