...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		Список, "ПредставлениеДополнительныеСведения", НСтр("ru = 'Дополнительные сведения'"), Истина);

	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		Список, "ПредставлениеДополнительныеРеквизиты", НСтр("ru = 'Дополнительные реквизиты'"), Истина);
